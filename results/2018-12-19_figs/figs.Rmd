...
save_plot("general_tsnes/cca/cca_gene_tsne.pdf", plt, nrow = 4, ncol = 2)
```
...
mat_vs_ph <- c(
  "Mature (INS+, IAPP+)" = "Maturing",
  "Igf2+" = "Maturing",
  "Immature (FEV+)" = "Maturing",
  "Beta subpopulation 2 and 4 (CD9+)" = "Maturing",
  "Proliferating (MKI67+)" = "Maturing",
  "Polyhormonal (GCG+)" = "Polyhormonal",
  "Polyhormonal (SST+)" = "Polyhormonal"
)

bcells$Sorted@meta.data$mat_ph <- mat_vs_ph[bcells$Sorted@meta.data$cell_type]
```
...
```{r}
plt <- plot_feature(bcells$Reaggregated, "cell_type") 
...
bcells <- map2(bcells, velocity_points,
  ...
  pca_space <- sobj@dr$pca@cell.embeddings
