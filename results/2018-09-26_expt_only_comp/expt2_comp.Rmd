...
clusters <- unique(bcells@meta.data$res.0.3)
...
readme_sheet <- data_frame(
  ...
  "",
  "If there are not enough cells for DE testing, then the cluster is missing from the analysis",
  "",
...
openxlsx::write.xlsx(c(readme_sheet, 
                       list_of_markers),
                     "expt2_markers_between_conditions_per_cluster.xlsx")
```
