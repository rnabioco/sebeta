...
write_tsv(deseq2_gene_level, "deseq2_gene_level.tsv")
...
openxlsx::write.xlsx(output, "deseq2_results.xlsx")
...
### GO terms
```{r, eval = F}
res <- readxl::read_excel("deseq2_results.xlsx",
                          sheet = 2)
...
```{r}
library(cowplot)
gprofiler_res <- read_csv("gProfiler_res.csv")
...
save_plot("Go_term_enrichment.pdf", p, nrow = 2.2, ncol = 1, base_asp = 2)
```
...
write_tsv(deseq2_gene_level, "deseq2_gene_level_d23_d30.tsv")
