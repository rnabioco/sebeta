...
markers <- suppressMessages(read_tsv("res0.3_markers.txt"))
...
cluster_ids <- bcell@meta.data$res.0.3
cell_ids <- bcell@cell.names
expt <- bcell@meta.data$expt
